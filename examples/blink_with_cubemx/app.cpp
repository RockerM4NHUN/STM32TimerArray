...
// In this example we use the CPU's frequency (what was set in CubeMX).
...
// In this example the target frequency is 1 kHz or 1000 Hz.
...
Timer t_toggle(
    500,       // the number of ticks to wait
...
void app_start(){
    ...
    // Attach before begin is also valid.
